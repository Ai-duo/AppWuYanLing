...
import com.kelin.add.kelinsite.add.OxygenNd;
...
public class MainActivity extends Activity {
    ...
    private void initView() {
        ...
        name.getPaint().setAntiAlias(false);
    ...
    SimpleDateFormat dateFormat = new SimpleDateFormat("E HH:mm", Locale.CHINA);
    ...
    public void setText(Elements elements) {
       ...
       /* if(!TextUtils.isEmpty(elements.getElementLeftText())){
        ...
        elementFragment.updateText("负氧离子:" + oxy+"个\n"+rightText);
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void setOxy(OxygenNd nd) {
        try {
            String[] nds = nd.nongdu.split(":");
    ...
    public void updateWeaInfo(String info) {
        ...
        //weatherinfo.setContent("航天新气象欢迎您！" +" 今天多云，偏东风3到4级，今天白天最高气温17℃，明天早晨最低气温9℃, 未来几天我市天气较好，总体维持晴好天气，气温略有起伏");//设置文本
        // weatherinfo.continueRoll();
    }
}
